...
// Initialize localStorage-based storage for development
if (typeof window !== 'undefined') {
  const savedData = localStorage.getItem('chichaAroundMeData');
  if (savedData) {
...
const saveToStorage = () => {
  if (typeof window !== 'undefined') {
    localStorage.setItem('chichaAroundMeData', JSON.stringify(mockDatabase));
  }
};
